...
- [unifont](https://unifont.dev) resolves font metadata from a provider. It ships the `google`, `adobe`, `bunny`, `fontshare`, `fontsource` and `npm` providers, and you can write your own against the same interface. Source at [unjs/unifont](https://github.com/unjs/unifont).
