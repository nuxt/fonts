...
describe('providers', async () => {
  ...
  it('generates inlined font face rules for `google` provider', async () => {
    ...
    expect(poppins[0]).toMatchInlineSnapshot(`"@font-face{font-family:Poppins;src:local("Poppins Regular Italic"),local("Poppins Italic"),url(/_fonts/file.woff) format(woff);font-display:swap;font-weight:400;font-style:italic}"`)
