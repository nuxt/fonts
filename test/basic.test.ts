...
describe('features', () => {
  ...
  it('supports `@unocss/nuxt`', async () => {
    ...
    expect(barlow[0]).toMatchInlineSnapshot(`"@font-face{font-family:Barlow;src:local("Barlow Regular"),local("Barlow"),url(/_fonts/file.woff) format(woff);font-display:swap;font-weight:400;font-style:normal}"`)
  })
