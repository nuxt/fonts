  ...
  it('generates inlined font face rules for `fontsource` provider', async () => {
    ...
    expect(extractFontFaces('Roboto Mono', html)).toMatchInlineSnapshot(`
      [
        ...
        "@font-face{font-family:Roboto Mono;src:local("Roboto Mono Variable"),url(/_fonts/file.woff2) format(woff2);font-display:swap;unicode-range:U+0460-052F,U+1C80-1C88,U+20B4,U+2DE0-2DFF,U+A640-A69F,U+FE2E-FE2F;font-weight:100 700;font-style:italic}",
        ...
        "@font-face{font-family:Roboto Mono;src:local("Roboto Mono Variable"),url(/_fonts/file.woff2) format(woff2);font-display:swap;unicode-range:U+0301,U+0400-045F,U+0490-0491,U+04B0-04B1,U+2116;font-weight:100 700;font-style:italic}",
        ...
        "@font-face{font-family:Roboto Mono;src:local("Roboto Mono Variable"),url(/_fonts/file.woff2) format(woff2);font-display:swap;unicode-range:U+0370-0377,U+037A-037F,U+0384-038A,U+038C,U+038E-03A1,U+03A3-03FF;font-weight:100 700;font-style:italic}",
        ...
        "@font-face{font-family:Roboto Mono;src:local("Roboto Mono Variable"),url(/_fonts/file.woff2) format(woff2);font-display:swap;unicode-range:U+0102-0103,U+0110-0111,U+0128-0129,U+0168-0169,U+01A0-01A1,U+01AF-01B0,U+0300-0301,U+0303-0304,U+0308-0309,U+0323,U+0329,U+1EA0-1EF9,U+20AB;font-weight:100 700;font-style:italic}",
        ...
        "@font-face{font-family:Roboto Mono;src:local("Roboto Mono Variable"),url(/_fonts/file.woff2) format(woff2);font-display:swap;unicode-range:U+0100-02AF,U+0304,U+0308,U+0329,U+1E00-1E9F,U+1EF2-1EFF,U+2020,U+20A0-20AB,U+20AD-20C0,U+2113,U+2C60-2C7F,U+A720-A7FF;font-weight:100 700;font-style:italic}",
